      ...
      <div className="p-4 space-y-3">
        <div className="flex items-center">
          {currentStep > 1 && (
            <button
              onClick={back}
              className="p-2 -ml-2 text-slate-400 transition-colors hover:text-slate-900 dark:hover:text-white"
              aria-label="Go back"
            >
